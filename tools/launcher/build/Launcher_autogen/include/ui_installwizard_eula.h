/********************************************************************************
** Form generated from reading UI file 'installwizard_eula.ui'
**
...
#ifndef UI_INSTALLWIZARD_EULA_H
#define UI_INSTALLWIZARD_EULA_H
...
class Ui_InstallWizard_Eula
{
public:
    QVBoxLayout *verticalLayout;
    QPlainTextEdit *plainTextEdit;

    void setupUi(QWizardPage *InstallWizard_Eula)
    {
        if (InstallWizard_Eula->objectName().isEmpty())
            InstallWizard_Eula->setObjectName("InstallWizard_Eula");
        InstallWizard_Eula->resize(640, 480);
        verticalLayout = new QVBoxLayout(InstallWizard_Eula);
        verticalLayout->setObjectName("verticalLayout");
        plainTextEdit = new QPlainTextEdit(InstallWizard_Eula);
        ...
        retranslateUi(InstallWizard_Eula);

        QMetaObject::connectSlotsByName(InstallWizard_Eula);
    } // setupUi

    void retranslateUi(QWizardPage *InstallWizard_Eula)
    {
        InstallWizard_Eula->setWindowTitle(QCoreApplication::translate("InstallWizard_Eula", "WizardPage", nullptr));
        plainTextEdit->setPlainText(QCoreApplication::translate("InstallWizard_Eula", "LIMITED USE SOFTWARE LICENSE AGREEMENT\n"
"\n"
"\n"
"\n"
...
"YOU ACKNOWLEDGE THAT YOU HAVE READ THIS AGREEMENT, YOU UNDERSTAND THIS AGREEMENT, AND UNDERSTAND THAT BY CONTINUING THE INSTALLATION OF THE SOFTWARE, BY LOADING OR RUNNING THE SOFTWARE, OR BY PLACING OR COPYING THE SOFTWARE ONTO YOUR COMPUTER HARD DRIVE OR RAM, YOU AGREE TO BE BOUND BY THE TERMS AND CONDITIONS OF THIS AGREEMENT.  YOU FURTHER AGREE THAT, EXCEPT FOR WRITTEN SEPARATE AGREEMENTS BETWEEN ID AND YOU, THIS AGREEMENT IS A COMPLETE AND EXCLUSIVE STATEMENT OF THE RIGHTS AND LIABILITIES OF THE PARTIES HERETO.  THIS AGREEMENT SUPERSEDES ALL PRIOR ORAL AGREEMENTS, PROPOSALS OR UNDERSTANDINGS, AND ANY OTHER COMMUNICATIONS BETWEEN"
                        " ID AND YOU RELATING TO THE SUBJECT MATTER OF THIS AGREEMENT.", nullptr));
    } // retranslateUi

};

namespace Ui {
    class InstallWizard_Eula: public Ui_InstallWizard_Eula {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_INSTALLWIZARD_EULA_H
